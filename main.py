...
@bot.command()
async def hello(ctx):
    await bot.change_presence(activity=CustomActivity(name="Hi!", type=ActivityType.custom))
...
@bot.command()
async def start(ctx):
    await bot.change_presence(activity=CustomActivity(name="Starting the Server", type=ActivityType.custom))
    server.StartServer()
...
@bot.command()
async def stop(ctx):
    await bot.change_presence(activity=CustomActivity(name="Stopping the Server", type=ActivityType.custom))
...
async def status(ctx):
    await bot.change_presence(activity=CustomActivity(name="Sending Server Status", type=ActivityType.custom))
...
async def headlines(ctx):
    await bot.change_presence(activity=CustomActivity(name="Sending News Headlines", type=ActivityType.custom))
...
async def sources(ctx, arg):
    await bot.change_presence(activity=CustomActivity(name="Sending News", type=ActivityType.custom))
...
@bot.command()
async def help(ctx):
    await bot.change_presence(activity=CustomActivity(name="Sending help", type=ActivityType.custom))
